...
describe('Test public projects controller', function () {
  it('Request /api/projects without authentication should result ok', function () {
    return __awaiter(void 0, void 0, void 0, function () {
      var result;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, supertest_1.default(app_1.default).get('/api/projects').send()];
          case 1:
            result = _a.sent();
  ...
  it('Request /api/projects should return 1 project with public status', function () {
    return __awaiter(void 0, void 0, void 0, function () {
      var result, projects;
      return __generator(this, function (_a) {
        switch (_a.label) {
